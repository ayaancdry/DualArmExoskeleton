...
saveas(fig3,'report/Figure3_Joint_Angles.png');
...
sgtitle('Joint Velocity Trajectories vs. Time (for analysis)','FontWeight','bold');
saveas(fig4,'report/Figure4_Joint_Velocities.png');
end
